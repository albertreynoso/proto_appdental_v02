...
class NuevoTratamiento extends StatefulWidget {
  ...
  const NuevoTratamiento({Key? key, required this.paciente}) : super(key: key);
...
class _NuevoTratamientoState extends State<NuevoTratamiento> {
  ...
  List<ItemPresupuesto> _presupuesto = [ItemPresupuesto()];
  ...
  void _inicializarControllers() {
    ...
    _cantidadCitasController = TextEditingController(text: '1');
  }
      ...
      children: [
        ...
        Expanded(
          child: ElevatedButton(
            onPressed: _isGuardando ? null : _guardarTratamiento,
  ...
  Future<void> _guardarTratamiento() async {
    ...
    try {
      ...
      final tratamientoData = {
        ...
        'monto_abonado': 0.0,
        'pago_pendiente': totalPresupuesto,
        'pagado': false,
        'paciente_id': widget.paciente['id'],
        'paciente_nombre': widget.paciente['nombre'],
        'creador_id': '',
        'creador_nombre': '',
        'citas': [],
        'estado': 'activo',
      ...
      if (mounted) {
        _mostrarMensaje('Tratamiento creado exitosamente');
        Navigator.pop(context, true);
      }
    } catch (e) {
      if (mounted) {
        setState(() => _isGuardando = false);
        _mostrarMensaje('Error al crear tratamiento: $e', esError: true);
      }
    }
  }
...
class ItemPresupuesto {
  ...
  final List<SubitemPresupuesto> subitems;
